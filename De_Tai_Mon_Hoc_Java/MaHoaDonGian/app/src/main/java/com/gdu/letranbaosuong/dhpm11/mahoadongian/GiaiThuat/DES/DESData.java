...
public class DESData {
    public static int[] pc_1 = {57, 49, 41, 33, 25, 17, 9, 1, 58, 50,
    ...
    public static int[] ip_1 = {40, 8, 48, 16, 56, 24, 64, 32, 39, 7,
    ...
    public static int[] pc_p = {16, 7, 20, 21, 29, 12, 28, 17, 1, 15, 23,
            26, 5, 18, 31, 10, 2, 8, 24, 14, 32,
            27, 3, 9, 19, 13, 30, 6, 22, 11, 4, 25}; // Hoán vị 32 phần tử

    public static int[] nrOfShifts = {0, 1, 1, 2, 2, 2, 2, 2, 2, 1,
