...
public class TransformTables {
    public static String[][] sbox = new String[][]{
    ...
    public static String[][] inverse_sbox = new String[][]{
    ...
    public static Matrix MixColumnFactor = new Matrix(BaseTransform.FromHexToBinary("02010103030201010103020101010302"));
    public static Matrix Inverse_MixColumFactor = new Matrix(BaseTransform.FromHexToBinary("0e090d0b0b0e090d0d0b0e09090d0b0e"));

    public static List<Matrix> Rcon = new List<Matrix>() {
        @Override
        public int size() {
            return Rcon.size();
        }
